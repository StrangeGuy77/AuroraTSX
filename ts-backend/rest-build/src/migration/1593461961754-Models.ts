...
export class Models1593461961754 implements MigrationInterface {
  name = "Models1593461961754";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "book" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying(50) NOT NULL, "description" character varying(2000) NOT NULL, "author" character varying(30) NOT NULL, "price" double precision NOT NULL, "extension" character varying(5) NOT NULL, "publisher" character varying(50) NOT NULL, "publisherYear" date NOT NULL, "writingYear" date NOT NULL, "categories" character varying array NOT NULL, "filename" character varying(50) NOT NULL, "views" integer NOT NULL DEFAULT 0, "likes" integer NOT NULL DEFAULT 0, "timesDownloaded" integer NOT NULL DEFAULT 0, "userId" uuid, CONSTRAINT "PK_a3afef72ec8f80e6e5c310b28a4" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
