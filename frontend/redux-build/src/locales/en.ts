export default {
  userInfo: {
    ...
    onceRegisteredAgreementAccepted:
      "By registering, you declare that you accept our ",
    ...
    TheresAnUserWithThatEmailAlready:
      "There's an user with that email registered.",
  ...
  libraryInfo: {
    ...
    course: "",
    wishlistInfo:
      "Here you may found the books or courses which you marked with the heart icon and you've not bought. Along with this, you'll receive emails whenever a book or a course marked here get a discount or a giveaway.",
    bookSectionInfo: "",
    courseSectionInfo: "",
    bookshelfInfo:
      "This is your personal bookshelf. Here you'll found the books or courses you've already bought."
  },
  softwareInfo: {
    ...
    frameworkSelection:
      "Select the frameworks you used during the development, if any",
  ...
  ourServicesSection: {
    ...
    WebDesignsDesc:
      "We design innovative and dynamic websites focused on giving a differentiating user experience.",
    WebDevelopment: "Web development",
    WebDevelopmentDesc:
      "We develop Full Stack JS with the use of modern technologies and tools that guarantee efficiency.",
    ResponsiveDesigns: "Responsive design",
    ResponsiveDesignsDesc:
      "All our developments have user interfaces adaptable to any device (PC, Tablet, Mobile)",
    Consulting: "Consulting / Advice",
    ConsultingDesc:
      "If you have a web project started we will advise you at all levels.",
    Databases: "Databases",
    DatabasesDesc:
  ...
  sectionsInfo: {
    ...
    aboutAuroraContent:
      "Aurora Development is a project that seeks to integrate all the needs of developers within a single page in the most innovative way possible, providing a variety of services, languages and availability.",
    home: "Home",
    library: "Library",
    cancel: "Cancel",
    software: "Software",
  ...
  faq: {
    ...
    htuBAnswer:
      "You go to the 'library' section and from there you fill out the form with all the fields that come out as mandatory. You have to make sure that the extension of the book is .pdf or .epub and that it does not weigh more than 50mb",
    howLongDoesItTakesForAnAnswer:
      "How long does it take to offer a response to emails?",
    hldtAnswer:
      "In general, response times vary depending on the type of question you sent the email and its relevance. The Aurora Development team always tries to give a quick and concise answer to those who contact us, however, we give priority to those who contact us to present software, consulting and business developments, but we inevitably answer all emails that arrive in less 24 hours",
    whereToFindCookiesAndUserAgreement:
      "Where do I find the use and cookie policies?",
    wtfcAnswer:
      "Our use policies are accepted at the time the user uses our service and this is notified at the time he enters the page, and they can be found in the following link: ",
    whereToFindAModerator: "Where do I find a moderator?",
    htfmAnswer:
      "The moderators that make up the Aurora Development team can be contacted directly to the mail addressed to their specialties: support@aurorasitehost.com, these are responsible for reviewing disputes between users, review of uploaded files, authenticity and issues related to temporary bans or permanent users"
  },
  userAgreementPolicy: {
    ...
    userAgreementPrivacyPolicyFP:
      "This Privacy Policy sets forth the terms under which Aurora DevelopmentTM uses and protects the information that is provided by its users when using its website.",
    ...
    userAgreementReceivedData:
      "Our website may collect personal information, for example: name, contact information such as your email address, telephone and cell phone number and demographic information. Likewise, when necessary, specific information may be required to process an order or make a delivery or billing.",
    ...
    userAgreementDataUseSP:
      "Aurora DevelopmentTM is highly committed to fulfill the commitment to keep your information secure. We use the most advanced systems and constantly update them to ensure that there is no unauthorized access.",
    ...
    userAgreementCookiesSP:
      "You can delete cookies at any time from your computer. However, cookies help to provide a better service for websites, they do not give access to information from your computer or from you, unless you want to and provide it directly.",
    userAgreementCookiesTP:
      "You can accept or deny the use of cookies, however most browsers accept cookies automatically as it serves to have a better web service. You can also change your computer settings to decline cookies. If they decline, you may not be able to use some of our services.",
    userAgreementThirdPartyLinksTitle: "Links to third parties",
    userAgreementThirdPartyLinks:
      "This website may contain links to other sites that may be of interest to you. Once you click on any of these links and leave our page, we no longer have control over the site to which you are redirected and therefore we are not responsible for the terms or privacy or the protection of your data on those other sites. from third parties. These sites are subject to their own privacy policies, so it is recommended that you consult them to confirm that you agree with them.",
  ...
  errors: {
    ...
    error500:
      "Huh, apparently there was an error uploading the file, try again and make sure you upload a correct file. If this persists, contact an administrator.",
    error503:
      "Service not available. We are having internal problems, we expect understanding on your part.",
    error504:
      "There was a problem sending data to the server. Check your internet connection and try again."
  }
};
